...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.addMarker(MarkerOptions()
            ...
            .title("Marker in Sydney").icon(BitmapDescriptorFactory.fromResource(R.drawable.mario)))
    ...
    fun loadPokemon(){
        listOfPokemon.add(pockemon(R.drawable.bulbasaur,"Pokemon 1","pkemon1 living here In Train Station ",55.0,31.6297,-8.019))
        listOfPokemon.add(pockemon(R.drawable.chamander,"Pokemon 2","living here In Marjane Agadir",95.0, 31.6294,  -8.0797))
        listOfPokemon.add(pockemon(R.drawable.squirtie,"Pokemon 3"," living here In Marjane Casa",33.0,31.6292,-8.079))
    }
}